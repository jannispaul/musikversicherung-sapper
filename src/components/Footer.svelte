...
<footer class="text-primary p-x1p5 text-x2 md:text-x0p5">
  ...
  <div
    ...
    <div class="flex-1 flex flex-col md:flex-row space-between">
      <a
        ...
        class="flex-1 hover:underline mb-x0p5 md:mb-0"
        title="B!-Das Versicherungsbüro anrufen">
        Tel.: +49 5191 931 31 99
      </a>
      <a
        href="tel:+491725113611"
        class="flex-1 hover:underline mb-x0p5 md:mb-0"
        title="B!-Das Versicherungsbüro mobile anrufen">
  ...
  <div class="md:flex mb-x1 md:mb-x0p5">
    <nav class="flex-1 mb-x0p5 md:mb-0">
      <a
        rel="prefetch"
        href="/impressum"
        title="Impressum aufrufen"
    ...
    <div class="flex-1">
      <a
        rel="prefetch"
        href="/versicherungsbedingungen"
        title="Versicherungsbedingungen aufrufen"
      ...
      <a
        ...
        class="hover:underline mb-x0p5 md:mb-0"
        title="Beschwerden-Seite aufrufen">
        Beschwerden
      </a>
