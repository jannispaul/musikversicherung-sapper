# sapper tailwind site

To run in dev run `npm run watch:tailwind` and then in spereate terminal window `npm run dev`

Setup according to (https://github.com/tailwindcss/setup-examples/tree/master/examples/sapper)
